...
interface OrganizationPrefixConfigurationMapper {
    ...
    fun toDto(entity: OrganizationPrefixConfigurationEntity): PrefixConfigurationResponseDto
    ...
    fun updateEntity(
        ...
        @MappingTarget entity: OrganizationPrefixConfigurationEntity
    ): OrganizationPrefixConfigurationEntity
}
