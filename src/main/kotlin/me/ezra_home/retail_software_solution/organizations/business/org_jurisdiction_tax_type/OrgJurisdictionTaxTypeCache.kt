...
class OrgJurisdictionTaxTypeCache(
    ...
    @Cacheable
    fun getAll(): Collection<OrgJurisdictionTaxTypeEntity> = orgJurisdictionTaxTypeRepository.findAll()

    @CacheEvict(allEntries = true)
    fun saveAll(entities: Collection<OrgJurisdictionTaxTypeEntity>) {
        orgJurisdictionTaxTypeRepository.saveAll(entities)
    }
}
