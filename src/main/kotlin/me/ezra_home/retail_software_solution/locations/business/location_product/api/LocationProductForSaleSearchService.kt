...
import me.ezra_home.retail_software_solution.locations.business.location_product.LocationProductForSaleQuerySearchService
...
class LocationProductForSaleSearchService(
    private val locationProductForSaleQuerySearchService: LocationProductForSaleQuerySearchService,
) {

    fun search(
        pageRequest: PageRequest<SaleProductSearchParameters, String>
    ): PageResponse<LocationProductForSaleDto, String> {
        val page = locationProductForSaleQuerySearchService.searchWithParameters(toUnderlyingPageRequest(pageRequest))
