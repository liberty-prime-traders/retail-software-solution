package me.ezra_home.retail_software_solution.locations.rest.endpoints.prefix_sequence_tracker
...
@Entity
@Table(name = TableNames.PREFIX_SEQUENCE_TRACKER)
class LocationPrefixSequenceTrackerEntity(
