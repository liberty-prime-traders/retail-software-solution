...
interface TitleMapper {
    ...
    fun toDto(titleEntity: TitleEntity): TitleResponseDto
    ...
    fun toEntity(titleInsertDto: TitleInsertDto): TitleEntity
    ...
    fun partialUpdate(titleUpdateDto: TitleUpdateDto, @MappingTarget titleEntity: TitleEntity)
}